namespace MusicBeePlugin
{
    public partial class IPCInterface
    {
        ...
        public enum Command
        {
            ...
            GetDownloadedLyrics                 = 144,      // WM_USER                  New#
            GetArtwork                          = 145,      // WM_USER
            GetArtworkUrl                       = 146,      // WM_USER                  New#
            GetDownloadedArtwork                = 147,      // WM_USER                  New#
            GetDownloadedArtworkUrl             = 148,      // WM_USER                  New#
            GetArtistPicture                    = 149,      // WM_USER                  New#
            GetArtistPictureUrls                = 150,      // WM_USER                  New#
            GetArtistPictureThumb               = 151,      // WM_USER                  New#
            IsSoundtrack                        = 152,      // WM_USER                  New#
            GetSoundtrackPictureUrls            = 153,      // WM_USER                  New#
            GetCurrentIndex                     = 154,      // WM_USER
            GetNextIndex                        = 155,      // WM_USER                  New#
            IsAnyPriorTracks                    = 156,      // WM_USER                  New#
            IsAnyFollowingTracks                = 157,      // WM_USER                  New#
            ...
            MoveFiles                           = 163,      // WM_COPYDATA              New#
            ShowNowPlayingAssistant             = 164,      // WM_USER
            GetShowTimeRemaining                = 165,      // WM_USER                  New#
            GetShowRatingTrack                  = 166,      // WM_USER                  New#
            GetShowRatingLove                   = 167,      // WM_USER                  New#
            GetButtonEnabled                    = 168,      // WM_USER                  New#
            Jump                                = 169,      // WM_USER                  New#
            Search                              = 170,      // WM_COPYDATA              New#
            SearchFirst                         = 171,      // WM_COPYDATA              New#
            SearchIndices                       = 172,      // WM_COPYDATA              New#
            SearchFirstIndex                    = 173,      // WM_COPYDATA              New#
            SearchAndPlayFirst                  = 174,      // WM_COPYDATA              New#
